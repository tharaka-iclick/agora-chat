...
// import 'package:chat_app/logs.dart';
...
//     }
//     try {
//       Map<dynamic, dynamic> result = await widget.client.queryPeersOnlineStatus(
//         [_peerUserId.text],
//       );
...
//         'Send peer message error: ' + errorCode.toString(),
//       );
//     }
//   }
...
//         AgoraRtmMessage.fromText(_channelMessage.text),
//       );
//       widget.logController.addLog('Send channel message success.');
//     } catch (errorCode) {
//       widget.logController.addLog(
//         'Send channel message error: ' + errorCode.toString(),
//       );
//     }
//   }
