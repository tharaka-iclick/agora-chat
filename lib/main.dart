import 'package:chat_app/user02.dart';
...
class AgoraChatConfig {
  ...
  static const String userId = "dilshan";
  static const String agoraToken =
      "007eJxTYGh0/Ny8ZtWkyUF757yrKdn2t3OpQ5m36qxH/Nz15jkrPy1WYEhMNLE0SjS3MDQ0TTGxNEi0MLBIMklLs0g0TDZNNTZLnuP4OL0hkJHhTYUdAyMDKxAzMoD4KgxJhsnGhqbmBroGloaWuoaGaQa6iWYGxroWlkbGQNOSklLSjAEx5Shv";
}
        ...
        case MessageType.TXT:
          {
            ...
            print(
              "receive text message: ${body.content}, from: ${msg.from} ${msg.from != AgoraChatConfig.userId}",
            );
          }
          break;
          ...
          children: [
            ...
            TextButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => User02()),
                );
              },
              child: const Text("Go to User02"),
              style: ButtonStyle(
                foregroundColor: WidgetStateProperty.all(Colors.white),
...
//   @override
//   Widget build(BuildContext context) {
//     // final time = DateFormat('HH:mm').format(DateTime.fromMillisecondsSinceEpoch(message.localTime));
...
//             padding: const EdgeInsets.all(12),
//             decoration: BoxDecoration(
//               color: isSent ? Colors.teal[100] : Colors.white,
//               borderRadius: BorderRadius.only(
...
//                   Text((message.body as ChatTextMessageBody).content),
//                 SizedBox(height: 4),
//                 // Text(
//                 //   time,
//                 //   style: TextStyle(
